...
public class MusicControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        music = new Music();
        music.setTrackId(1);
        music.setTrackName("yarallisound");
        music.setTrackComment("yash");
        list = new ArrayList();
        list.add(music);
    }
    ...
    @Test
    public void updateMusic() throws TrackNotFoundException,Exception {
        when(musicService.updateMusic("udaya",1)).thenReturn(music);
    ...
    public void findByName() throws Exception {
        when(musicService.findByTrackName("udaya")).thenReturn(list);
        mockMvc.perform(MockMvcRequestBuilders.get("/music/1")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(music)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
